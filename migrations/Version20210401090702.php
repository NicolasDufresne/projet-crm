 ...
 */
final class Version20210401090702 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE appointment (id INT AUTO_INCREMENT NOT NULL, ticket_id INT DEFAULT NULL, compagny_id INT DEFAULT NULL, client_id INT DEFAULT NULL, user_id INT DEFAULT NULL, object VARCHAR(128) NOT NULL, date_time DATETIME DEFAULT NULL, INDEX IDX_FE38F8445774FDDC (ticket_id), INDEX IDX_FE38F844BE539471 (compagny_id), INDEX IDX_FE38F844DC2902E0 (client_id), INDEX IDX_FE38F8449D86650F (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(128) NOT NULL, name VARCHAR(128) NOT NULL, first_name VARCHAR(128) NOT NULL, phonenumber VARCHAR(128) DEFAULT NULL, adress VARCHAR(128) NOT NULL, cp VARCHAR(128) NOT NULL, city VARCHAR(128) NOT NULL, status VARCHAR(128) NOT NULL, commitment VARCHAR(128) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE exchange (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, compagny_id INT NOT NULL, type VARCHAR(128) NOT NULL, detail VARCHAR(128) DEFAULT NULL, relation INT NOT NULL, INDEX IDX_D33BB079DC2902E0 (client_id), INDEX IDX_D33BB079BE539471 (compagny_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, ticket_id INT NOT NULL, client_id INT DEFAULT NULL, compagny_id INT NOT NULL, user_id INT NOT NULL, ref VARCHAR(128) NOT NULL, status VARCHAR(128) NOT NULL, tva DOUBLE PRECISION NOT NULL, ttc DOUBLE PRECISION NOT NULL, ht DOUBLE PRECISION NOT NULL, INDEX IDX_906517445774FDDC (ticket_id), INDEX IDX_90651744DC2902E0 (client_id), INDEX IDX_90651744BE539471 (compagny_id), INDEX IDX_906517449D86650F (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quotation (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, compagny_id INT DEFAULT NULL, ref VARCHAR(128) NOT NULL, status VARCHAR(128) NOT NULL, tva DOUBLE PRECISION NOT NULL, ttc DOUBLE PRECISION NOT NULL, ht DOUBLE PRECISION NOT NULL, INDEX IDX_474A8DB9DC2902E0 (client_id), INDEX IDX_474A8DB9BE539471 (compagny_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, exchange_id INT NOT NULL, category_id INT DEFAULT NULL, object VARCHAR(128) NOT NULL, details VARCHAR(128) DEFAULT NULL, status VARCHAR(128) NOT NULL, INDEX IDX_97A0ADA36173D21F (exchange_id), INDEX IDX_97A0ADA39777D11E (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(128) NOT NULL, first_name VARCHAR(128) NOT NULL, phonenumber VARCHAR(128) NOT NULL, adress VARCHAR(128) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
