 ...
 */
final class Version20210422123908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, ticket_id_id INT NOT NULL, client_id_id INT DEFAULT NULL, compagny_id_id INT NOT NULL, user_id_id INT NOT NULL, ref VARCHAR(128) NOT NULL, status VARCHAR(128) NOT NULL, tva DOUBLE PRECISION NOT NULL, ttc DOUBLE PRECISION NOT NULL, ht DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_906517445774FDDC (ticket_id_id), INDEX IDX_90651744DC2902E0 (client_id_id), INDEX IDX_90651744BE539471 (compagny_id_id), INDEX IDX_906517449D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
